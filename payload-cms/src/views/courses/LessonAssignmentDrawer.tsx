...
// Attach-only drawer: pull existing lessons in from elsewhere. New-lesson
// creation lives in the inline input + scaffold-page flow so the DB row only
// gets written when the staff member explicitly saves.
export default function LessonAssignmentDrawer({
  ...
  const footer = (
    <div className="flex items-center justify-between gap-2">
      <div className="text-xs text-[var(--cpp-muted)]">{selectedIds.size} selected</div>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className="truncate font-medium text-[var(--cpp-ink)]">{result.title}</div>
